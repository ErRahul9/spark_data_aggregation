...
class BidderLogAggregationMin:
    ...
    def data_source_athena_table(self) -> str:
        return f"data_archive_{self.env}.bid_price_logs_aggregated_min"
    ...
    def _get_bidder_logs_df(self) -> Dict[str, List[DataFrame]]:
        ...
        df_cg_id_data = df_cg_id_agg.join(
            ...
            on=["dt", "hh", "min", "campaign_group_id", "flight_id"],
            how="outer",
        )
        ...
        df_camp_data = df_cam_agg.join(
            ...
            on=["dt", "hh", "min", "campaign_group_id", "campaign_id"],
            how="inner",
        )

        return {
            "campaign_group_log_agg_min": [df_cg_id_data],
            "campaign_log_agg_min": [df_camp_data],
            "terms_log_agg_min": [df_term_agg],
        }
